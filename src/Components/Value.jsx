...
const Value = () => {
  return (
    <div className="main-value flex items-center justify-around my-10 md:my-28  px-16 md:px-20 flex-wrap-reverse ">
      <div className="image">
        <img className='w-[370px] rounded-3xl bg-no-repeat mt-6 md:mt-none' src="https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8d29ya291dHxlbnwwfHwwfHx8MA%3D%3D" alt="" />
      </div>
      <div className="right-text">
        <div className="headiing-text flex items-center justify-start gap-4">
          <FaHandsHelping className='text-yellow-800 bg-white shadow-custom text-4xl md:text-5xl rounded-lg py-2' />
