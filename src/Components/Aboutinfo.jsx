...
const Aboutinfo = () => {
  return (
    ...
    <div className="main-about w-full my-10  md:my-20 px-20  ">
      ...
      <div className="aboutifo grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 px:10 md:px-28 ">
        <div className="left">
