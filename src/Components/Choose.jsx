...
const Choose = () => {
  return (
   <>
   <div className="choose w-full mt-20  sm:px-22 h-auto   ">
    ...
    <div className="choose-banner grid sm:grid-cols-2 sm:px-6 md:px-0 items-center justify-center  md:grid-cols-3 lg:grid-cols-4 mt-4  md:mt-9 ">
      {choose.map(({title, description, icon}, index) => (
        <div className="card w-[200px] sm:w-[300px] h-auto my-2 md:my-4 text-center   " key={index} >
