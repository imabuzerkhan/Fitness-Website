...
const Programs = () => {
  return (
    <div className="main-programs py-4 px-10 w-full mt-20">
      <h1 className='font-["Kanit"] text-4xl font-[800] flex items-center gap-2'>
        <FaCrown className='text-yellow-800 bg-white shadow-custom  cursor-pointer p-1 rounded-md text-4xl ' />Programs
      </h1>
      <div className="main-card grid grid-cols-2 md:grid-cols-4 gap-3 px-12 mt-8 items-center justify-center">
        {fitnessData.map(({ title, description, icon }, index) => (
          <div key={index} className="card bg-yellow-800 shadow-xl pt-4 pb-4 px-5 rounded-tr-3xl  h-[16rem]    ">
